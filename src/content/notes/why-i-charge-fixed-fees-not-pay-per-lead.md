...
description: "Fixed-fee vs pay-per-lead SEO for service businesses: who owns the rankings, what the alignment problem actually is, and when each model makes sense."
...
For the full picture of what fixed-fee SEO work looks like, see [Local SEO for Service Businesses](/services/local-seo/). For the case study where we replaced a national pay-per-lead service with owned infrastructure, see [the case study](/work/pest-control-vancouver/).
