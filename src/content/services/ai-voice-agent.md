...
**Handoff.** When the caller has a question the agent can't answer — an unusual job type, a complaint, someone asking to speak to a human — the agent transfers with full call context. The person who picks up already knows what the call is about.
...
- **Pest control** — high call volume, seasonal surges, complex triage (pest type × property type × urgency), after-hours demand
